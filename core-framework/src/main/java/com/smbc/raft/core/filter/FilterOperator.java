 ...
 *
 * <ul>
 *   <li><b>Ordering</b> ({@code >}, {@code <}, {@code >=}, {@code <=}) &mdash; perform numeric
 *       comparison when both operands parse as numbers, otherwise fall back to lexicographic
 *       comparison.
 *   <li><b>Equality / text</b> ({@code ==}, {@code !=}, {@code contains}, {@code startsWith},
 *       {@code endsWith}) &mdash; operate on string values.
 * </ul>
 */
