package com.smbc.raft.core.api;
...
public class RestAssuredClient {
  ...
  /**
   * Enable relaxed HTTPS validation (trust all certificates). Useful for testing against
  ...
  public Response get(String endpoint) {
    ...
    Response response =
        RestAssured.given().spec(requestSpec).when().get(endpoint).then().extract().response();
  ...
  public Response post(String endpoint) {
    log.info("Sending POST request to: {}", endpoint);
    Response response =
        RestAssured.given().spec(requestSpec).when().post(endpoint).then().extract().response();
  ...
  public Response delete(String endpoint) {
    ...
    Response response =
        RestAssured.given().spec(requestSpec).when().delete(endpoint).then().extract().response();
  ...
  public Response head(String endpoint) {
    ...
    Response response =
        RestAssured.given().spec(requestSpec).when().head(endpoint).then().extract().response();
  ...
  public Response options(String endpoint) {
    ...
    Response response =
        RestAssured.given().spec(requestSpec).when().options(endpoint).then().extract().response();
