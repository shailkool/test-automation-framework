...
public class ConfigurationManager {
  ...
  /**
   * Resolves placeholders in the form of ${VAR} or ${ENV:VAR} using environment variables. Supports
   * nested placeholders and falls back to system properties.
   */
  private String resolvePlaceholders(String value) {
    ...
    while ((start = value.indexOf("${", lastPos)) != -1) {
      ...
      if (resolvedValue != null) {
        ...
        log.debug(
            "Placeholder '{}' could not be resolved from ENV or System properties", placeholder);
      }
