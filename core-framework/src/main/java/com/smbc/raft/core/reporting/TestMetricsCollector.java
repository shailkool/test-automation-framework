 ...
 *
 * <p>Emits a JSONL (JSON Lines) file containing detailed data for every test execution, including
 * duration, status, environment, and retry counts. This file serves as the source for time-series
 * analysis and trend dashboards (e.g., in Grafana or ELK).
 */
@Log4j2
