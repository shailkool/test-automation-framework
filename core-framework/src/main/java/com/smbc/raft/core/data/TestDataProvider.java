...
/** Utility class for TestNG data providers Supports data-driven testing from Excel and CSV files */
@Log4j2
public class TestDataProvider {

  /**
   * Data provider for Excel files Usage: @Test(dataProvider = "excelDataProvider",
  ...
  /**
   * Data provider for CSV files Usage: @Test(dataProvider = "csvDataProvider", dataProviderClass =
  ...
  public static Object[][] getExcelDataWhere(
      String filePath, String sheetName, String columnName, String value) {
    try {
      ExcelHandler excel = new ExcelHandler(filePath);
      excel.selectSheet(sheetName);
  ...
  public static Map<String, String> getExcelTestCase(
      String filePath, String sheetName, String testCaseName) {
    try {
      ExcelHandler excel = new ExcelHandler(filePath);
      excel.selectSheet(sheetName);
  ...
  /**
   * Convert Excel data to 2D array with separate parameters Useful when you want each column as a
   * separate parameter
   */
