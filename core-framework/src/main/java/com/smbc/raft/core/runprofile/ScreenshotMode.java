...
public enum ScreenshotMode {
    ...
    /**
     * Parse a user-supplied mode name (case-insensitive, tolerant of hyphens
     * and spaces). Returns {@link #ON_FAILURE} for unknown or blank input so
     * the framework defaults to the cheaper behaviour.
     */
