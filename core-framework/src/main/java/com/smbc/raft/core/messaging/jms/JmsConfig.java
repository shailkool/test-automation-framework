...
/**
 * Resolved JMS connection settings. Read from {@link ConfigurationManager}
 * under {@code jms.*} (default) or {@code jms.<name>.*}.
 *
 * <p>For IBM MQ, additional properties are read:
 * {@code jms.mq.queueManager}, {@code jms.mq.channel}, {@code jms.mq.host},
 * {@code jms.mq.port}, {@code jms.mq.transportType}.</p>
 */
@Data
@Builder
public class JmsConfig {
    ...
    public static JmsConfig fromConfig(String clientName) {
        ...
        return JmsConfig.builder()
                ...
                .destinationType(JmsDestinationType.fromString(
