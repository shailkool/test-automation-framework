...
/**
 * Shared context for data-driven steps to allow state sharing between different step definition
 * classes within a single scenario.
 */
public class CentralTestContext {

  private static final ThreadLocal<List<Map<String, String>>> SOURCE_ROWS =
      ThreadLocal.withInitial(ArrayList::new);
  private static final ThreadLocal<List<Map<String, String>>> FILTERED_ROWS =
      ThreadLocal.withInitial(ArrayList::new);
