...
/**
 * Transport-neutral message representation that flows through both Kafka and
 * JMS/MQ clients, so tests can assert against a single shape regardless of
 * which broker produced the payload.
 */
@Data
@Builder
@NoArgsConstructor
