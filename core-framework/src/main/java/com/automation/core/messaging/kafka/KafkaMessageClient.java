package com.automation.core.messaging.kafka;
...
/**
 * {@link MessageClient} facade that pairs a Kafka producer and a Kafka
 * consumer, allowing tests to hold a single handle for send + receive flows.
 */
@Log4j2
