...
/**
 * Per-file outcome produced by {@link DirectoryDiff}: the file's status on
 * both sides, the detailed {@link DiffResult} (when both sides had a copy),
 * and the filesystem path of the generated HTML detail report (when one was
 * rendered).
 */
@Getter
public class FileDiffResult {
    ...
    public int getChangedRows()   { return diffResult == null ? 0 : diffResult.getModifiedRows(); }
    public int getAddedRows()     { return diffResult == null ? 0 : diffResult.getAddedRows();    }
    public int getRemovedRows()   { return diffResult == null ? 0 : diffResult.getDeletedRows();  }
    public int getUnchangedRows() { return diffResult == null ? 0 : diffResult.getMatchedRows();  }
    ...
    public static class Builder {
        ...
        public Builder diffResult(DiffResult v) { this.diffResult = v; return this; }
        public Builder oldPath(String v)        { this.oldPath = v; return this; }
        public Builder newPath(String v)        { this.newPath = v; return this; }
        public Builder reportPath(String v)     { this.reportPath = v; return this; }
        public Builder oldRowCount(long v)      { this.oldRowCount = v; return this; }
        public Builder newRowCount(long v)      { this.newRowCount = v; return this; }
