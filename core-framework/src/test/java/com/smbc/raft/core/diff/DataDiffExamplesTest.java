...
import com.smbc.raft.core.data.ExcelHandler;
...
public class DataDiffExamplesTest extends BaseTest {
  ...
  public void testIdenticalData() {
    ...
    // Compare
    DataDiff diff = DataDiff.builder().keyField("ID").build();
  ...
  public void testModifiedData() {
    ...
    ExtentReportManager.logPass(
        "Modified data detected: " + rowDiff.getFieldDifferences().size() + " fields changed");
  }
  ...
  public void testCaseInsensitiveComparison() {
    ...
    DataDiff diff = DataDiff.builder().keyField("ID").ignoreCase(true).build();
  ...
  public void testIgnoreFields() {
    ...
    DataDiff diff = DataDiff.builder().keyField("ID").ignoreField("Status").build();
  ...
  public void testGenerateHTMLReport() {
    ...
    Assert.assertTrue(new java.io.File(reportPath).exists(), "HTML report should be generated");
  ...
  public void testCompareCSVFiles() {
    ...
    // Generate report
    DiffReportGenerator generator = new DiffReportGenerator();
    generator.saveReport(result, "CSV File Comparison", "test-output/csv-diff-report.html");
  ...
  public void testCompareExcelFiles() {
    ...
    // Generate report
    DiffReportGenerator generator = new DiffReportGenerator();
    generator.saveReport(result, "Excel File Comparison", "test-output/excel-diff-report.html");
  ...
  public void testCompareDatabaseResults() {
    ...
    DiffReportGenerator generator = new DiffReportGenerator();
    generator.saveReport(result, "Database Results Comparison", "test-output/db-diff-report.html");
