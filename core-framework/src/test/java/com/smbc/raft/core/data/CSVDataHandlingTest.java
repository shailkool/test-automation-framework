...
public class CSVDataHandlingTest extends BaseTest {
  ...
  public void testDeleteCSVRows() {
    ...
    Assert.assertEquals(afterDeleteCount, initialCount - 1, "Row count should decrease by 1");
  ...
  public void testExportDataToCSV() {
    ...
    Assert.assertTrue(new java.io.File(filePath).exists(), "CSV export file should be created");
  }
}
