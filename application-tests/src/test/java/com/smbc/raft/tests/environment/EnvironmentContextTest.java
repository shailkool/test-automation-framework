package com.smbc.raft.tests.environment;

import static org.testng.Assert.assertEquals;
import static org.testng.Assert.assertNotNull;
import static org.testng.Assert.assertTrue;

import com.smbc.raft.core.environment.DatabaseSettings;
import com.smbc.raft.core.environment.EnvironmentConfig;
import com.smbc.raft.core.environment.EnvironmentContext;
import com.smbc.raft.core.environment.MessageQueueSettings;
...
/**
 * Verifies the simplified environment config plumbing against the dev/qa/uat2 JSON files shipped
 * under {@code src/test/resources/environments}.
 */
public class EnvironmentContextTest {
  ...
  public void loadsQaFromSystemProperty() {
    ...
    assertTrue(
        config.getDatabases().containsKey("archiveDb"),
  ...
  public void bbcSiteCarriesItsOwnUserBase() {
    ...
    assertTrue(bbc.getUsers().containsKey("admin"), "BBC in qa should define an admin user");
    assertTrue(
        !yahoo.getUsers().containsKey("admin"), "Yahoo in qa should NOT inherit BBC's admin user");
