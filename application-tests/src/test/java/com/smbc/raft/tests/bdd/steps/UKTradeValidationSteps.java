...
/**
 * Step definitions for UK Repo Trade Data Validation.
 * Validates trade records and lifecycle events using mapping files.
 */
@Log4j2
public class UKTradeValidationSteps {
    ...
    public void theTestDataIsRelatedTo(String key) {
        ...
        Assert.assertNotNull(baseFolder, "Base folder property '" + key + "' not found in environment config");
    }
