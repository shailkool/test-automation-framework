...
public class UserApiTest extends BaseTest {
  ...
  @Test(
      ...
      description = "Verify getting all users returns 200 OK")
  public void testGetAllUsers() {
    ...
    Assert.assertTrue(
        response.jsonPath().getList("$").size() >= 0, "Response should be a JSON array");
  ...
  public void testUpdateUser() {
    ...
    // Verify updated data
    Assert.assertEquals(
        response.jsonPath().getString("name"), "Updated Name", "Name should be updated");
    Assert.assertEquals(response.jsonPath().getString("role"), "admin", "Role should be updated");
