...
public class UserDatabaseTest extends BaseTest {
    ...
    public void verifyPool() {
        ...
        log.info("Database Pool Identity: {}", com.smbc.raft.core.database.DatabaseManager.getInstance().toString());
        Assert.assertTrue(
            com.smbc.raft.core.database.DatabaseManager.getInstance().toString().contains("HikariDataSource"),
