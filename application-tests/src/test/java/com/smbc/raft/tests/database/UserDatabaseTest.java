package com.smbc.raft.tests.database;
...
public class UserDatabaseTest extends BaseTest {
  ...
  public void verifyPool() {
    ...
    log.info(
        "Database Pool Identity: {}",
        com.smbc.raft.core.database.DatabaseManager.getInstance().toString());
    Assert.assertTrue(
        com.smbc.raft.core.database.DatabaseManager.getInstance()
            .toString()
  ...
  @Test(
      ...
      description = "Verify user can be created in database")
  ...
  @Test(
      groups = {"regression"},
      description = "Verify user can be retrieved by ID")
  ...
  @Test(
      groups = {"regression"},
      description = "Verify user can be updated in database")
  ...
  @Test(
      groups = {"regression"},
      description = "Verify user can be deleted from database")
  ...
  @Test(
      groups = {"regression"},
      description = "Verify getting users by role")
