...
public class LoginTest extends BaseTest {
  ...
  public void testSuccessfulLogin() {
    ...
    Assert.assertTrue(
        homePage.isHomePageLoaded(), "Home page should be loaded after successful login");
  ...
  public void testLoginWithInvalidCredentials() {
    ...
    Assert.assertTrue(
        errorMessage.contains("Invalid credentials") || errorMessage.contains("Login failed"),
