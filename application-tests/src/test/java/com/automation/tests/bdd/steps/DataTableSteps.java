...
import com.automation.core.data.*;
...
public class DataTableSteps {
    ...
    public void iLoadAs(String relativePath, String tableName) {
        ...
        com.automation.core.data.CSVHandler handler = new com.automation.core.data.CSVHandler(fullPath);
    ...
    public void iJoinAndUsingIntoWithTheFollowingRules(
            String leftName, String rightName, String joinTypeStr, String resultName, DataTable ruleTable) {
    ...
    private void executeJoin(String leftName, String rightName, String joinTypeStr, String resultName, DataTable ruleTable) {
        ...
        List<Map<String, String>> result = engine.join(left, right, type, joinConditions, leftFilters, rightFilters);
        
        CentralTestContext.saveTable(resultName, result);
        CentralTestContext.setFilteredRows(result); // Also set as current result for "Then the resulting data should be:"
