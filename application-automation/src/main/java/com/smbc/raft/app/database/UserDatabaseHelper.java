...
/**
 * Database helper for User-related database operations This is an example - modify according to
...
public class UserDatabaseHelper {
  ...
  public int updateUser(int userId, String name, String email, String role) {
    ...
    String query =
        "UPDATE users SET name = ?, email = ?, role = ?, updated_at = CURRENT_TIMESTAMP WHERE user_id = ?";
